...
Note that the [Swift Package Manager](https://swift.org/package-manager) is still in early design and development, for more information checkout it's [GitHub Page](https://github.com/apple/swift-package-manager)
